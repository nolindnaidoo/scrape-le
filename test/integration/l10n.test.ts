 ...
 */
describe('Scrape-LE localization', function () {
	this.timeout(30_000);

	const extension = vscode.extensions.getExtension('nolindnaidoo.scrape-le');
	...
	it('substitutes positional placeholders at runtime', () => {
		...
		const one = vscode.l10n.t('✗ Failed to reach page: {0}', 7);
